...
module.exports = async function (context, req) {
    ...
    var download = ""
    var downloadpng = "https://jakubstorage.blob.core.windows.net/images/" + username + ".png";
    var downloadjpg = "https://jakubstorage.blob.core.windows.net/images/" + username + ".jpeg";
